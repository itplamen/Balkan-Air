        ...
        <ItemTemplate>
            <div id="TravelPlanDiv">
                ...
                <div id="TravelPlanFlightInfoDiv">
                    ...
                    <span class="fromAirportAbbreviationSpan"><%#: Item.Flight.DepartureAirport.Abbreviation %></span>
                    ...
                    <span class="toAirportAbbreviationSpan"><%#: Item.Flight.ArrivalAirport.Abbreviation %></span>
                    <span class="flightDateSpan"><%#: Item.Flight.Departure.ToString("ddd dd, MMM", CultureInfo.InvariantCulture) %></span>
                    ...
                    <span class="flightDateSpan"><%#: Item.Flight.Arrival.ToString("ddd dd, MMM", CultureInfo.InvariantCulture) %></span>
                    <span class="flightTimeSpan"><%#: Item.Flight.Arrival.ToString("HH:mm", CultureInfo.InvariantCulture) %></span>
                </div>
