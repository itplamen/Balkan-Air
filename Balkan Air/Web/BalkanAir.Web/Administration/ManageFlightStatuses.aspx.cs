namespace BalkanAir.Web.Administration
{
    ...
    public partial class ManageFlightStatuses : Page
    {
        ...
        public IQueryable<FlightStatus> ManageFlightStatusesGridView_GetData()
        {
            return this.FlightStatusesServices.GetAll()
                .OrderBy(fs => fs.Name);
        }

        public void ManageFlightStatusesGridView_UpdateItem(int id)
        {
        ...
        public void ManageFlightStatusesGridView_DeleteItem(int id)
        {
