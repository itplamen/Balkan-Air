<%@ Page Title="Manage User Notifications" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageUserNotifications.aspx.cs" Inherits="BalkanAir.Web.Administration.ManageUserNotifications" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: this.Page.Title %></h2>

    <asp:GridView ID="ManageUserNotificationsGridView" runat="server" CssClass="administrationGridView"
        ...
        DeleteMethod="ManageUserNotificationsGridView_DeleteItem"
        AllowSorting="true">
        <Columns>
