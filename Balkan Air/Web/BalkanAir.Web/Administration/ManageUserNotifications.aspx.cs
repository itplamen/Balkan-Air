namespace BalkanAir.Web.Administration
{
    ...
    public partial class ManageUserNotifications : Page
    {
        [Inject]
        ...
        public IQueryable<UserNotification> ManageUserNotificationsGridView_GetData()
        {
        ...
        public void ManageUserNotificationsGridView_UpdateItem(int id)
        {
        ...
        public void ManageUserNotificationsGridView_DeleteItem(int id, string userId)
        {
