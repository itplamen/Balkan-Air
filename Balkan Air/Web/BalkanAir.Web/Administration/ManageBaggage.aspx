<%@ Page Title="Manage Baggage" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageBaggage.aspx.cs" Inherits="BalkanAir.Web.Administration.ManageBaggage" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: this.Page.Title %></h2>

    <asp:GridView ID="ManageBaggageGridView" runat="server" CssClass="administrationGridView"
        ItemType="BalkanAir.Data.Models.Baggage"
        DataKeyNames="Id"
        AutoGenerateColumns="false"
        ShowHeaderWhenEmpty="true"
        PageSize="50"
        SelectMethod="ManageBaggageGridView_GetData"
        UpdateMethod="ManageBaggageGridView_UpdateItem"
        DeleteMethod="ManageBaggageGridView_DeleteItem"
        AllowSorting="true">
        <Columns>
