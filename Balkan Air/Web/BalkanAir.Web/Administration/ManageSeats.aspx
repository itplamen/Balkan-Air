<%@ Page Title="Manage Seats" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageSeats.aspx.cs" Inherits="BalkanAir.Web.Administration.ManageSeats" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: this.Page.Title %></h2>

    <asp:GridView ID="ManageSeatsGridView" runat="server" CssClass="administrationGridView"
        ...
        AllowPaging="true"
        PageSize="50"
        SelectMethod="ManageSeatsGridView_GetData"
        UpdateMethod="ManageSeatsGridView_UpdateItem"
        DeleteMethod="ManageSeatsGridView_DeleteItem"
        AllowSorting="true">
        <Columns>
